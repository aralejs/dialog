define("arale/dialog/0.9.3/anim-dialog-debug", [ "./base-dialog-debug", "$-debug", "arale/overlay/0.9.13/overlay-debug", "arale/position/1.0.0/position-debug", "arale/iframe-shim/1.0.0/iframe-shim-debug", "arale/widget/1.0.2/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug", "arale/easing/1.0.0/easing-debug", "arale/overlay/0.9.13/mask-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), Overlay = require("arale/overlay/0.9.13/overlay-debug"), easing = require("arale/easing/1.0.0/easing-debug"), BaseDialog = require("./base-dialog-debug");
    // AnimDialog
    // -------
    ...
    var AnimDialog = BaseDialog.extend({
        ...
        show: function() {
            ...
            this.element.hide();
            var elem = this.element, that = this, ef = this.get("showEffect");
            ...
            if (ef.type === "none") {
                ...
                var width = this._layer.get("width"), height = this._layer.get("height"), properties;
                // 位置和显示前的准备
        ...
        hide: function() {
            ...
            this.element.show();
            var elem = this.element, that = this, ef = this.get("hideEffect");
            ef = $.extend(null, this.get("effect"), ef);
            if (ef.type == null) {
                ef = {
                    type: "none"
