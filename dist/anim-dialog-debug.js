define("arale/dialog/0.9.2/anim-dialog-debug", ["./base-dialog-debug", "$-debug", "arale/overlay/0.9.13/overlay-debug", "arale/position/1.0.0/position-debug", "arale/iframe-shim/1.0.0/iframe-shim-debug", "arale/widget/1.0.2/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug", "arale/easing/1.0.0/easing-debug", "arale/overlay/0.9.13/mask-debug"], function(require, exports, module) {

    var $ = require('$-debug'),
        Overlay = require('arale/overlay/0.9.13/overlay-debug'),
